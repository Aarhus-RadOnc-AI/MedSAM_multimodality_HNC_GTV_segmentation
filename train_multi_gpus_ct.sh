...
dataroot="/mnt/nvme/jintao/medsam_hnc/npy/HNC_CT/trains"
dataval="/mnt/nvme/jintao/medsam_hnc/npy/HNC_CT/vals/"
pretrained_checkpoint="./work_dir/LiteMedSAM/lite_medsam.pth"

CUDA_VISIBLE_DEVICES=2,3 python train_multi_gpus_with_val.py \
    -i ${dataroot} \
    -val ${dataval} \
    -task_name MedSAM-Lite-hnc-ct\
