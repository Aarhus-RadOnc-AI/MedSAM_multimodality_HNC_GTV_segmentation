...
png_save_dir="/processing/jintao/medsam_hnc/png/HNC_blend/pred_finetune/"

# Directory to save predicted segmentation masks in *.nii.gz format.
nii_pred_dir="/processing/jintao/medsam_hnc/nii/HNC_blend/pred_finetune/"

# Directory to save bounding boxes in *.nii.gz format.
nii_box_dir="/processing/jintao/medsam_hnc/nii/HNC_blend/pred_finetune_box/"
