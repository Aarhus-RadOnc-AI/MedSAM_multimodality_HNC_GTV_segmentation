...
pred_save_dir="/mnt/nvme/jintao/medsam_hnc/npz/HNC_CT/pred_finetune/"
#medsam_lite_checkpoint_path="./work_dir/LiteMedSAM/lite_medsam.pth"
medsam_lite_checkpoint_path="./work_dir/LiteMedSAM/MedSAM-Lite-hnc-ct-20240131-0209/medsam_lite_best_epoch8.pth"

nii_img_dir="/data/jintao/nnUNet/nnUNet_raw_data_base/nnUNet_raw_data/Task901_AUH/imagesTs/"
png_save_dir="/mnt/nvme/jintao/medsam_hnc/png/HNC_CT/pred_finetune/"
nii_save_dir="/mnt/nvme/jintao/medsam_hnc/nii/HNC_CT/pred_finetune/"



CUDA_VISIBLE_DEVICES=2 python inference_3D_finetune.py \
    -data_root ${dataroot} \
