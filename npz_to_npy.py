...
parser.add_argument("-npz_dir", type=str, default="/mnt/nvme/jintao/medsam_hnc/npz/HNC_CT/tests/",
                    help="Path to the directory containing preprocessed .npz data, [default: data/npz/MedSAM_train/CT_Abd]")
parser.add_argument("-npy_dir", type=str, default="/mnt/nvme/jintao/medsam_hnc/npy/HNC_CT/tests/",
